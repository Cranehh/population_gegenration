...
class PopulationDiT(nn.Module):
    ...
    def forward(self, family_data, person_data, cluster, person_mask, t, t_person):
        """
        ...
        person_final_out = self.forward_person(person_data, node_embeddings, family_final_out, t_person, person_mask, cluster)
    ...
    def reference_all(self, x, t, cluster):
